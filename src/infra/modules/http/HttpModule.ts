...
import CreateTransactionController from './controllers/clientes/CreateTransactionController'
import ListTransactionController from './controllers/clientes/ListTransactionController'

@injectable()
export default class HttpModule extends Module {
  private server = new HyperExpress.Server({ trust_proxy: false })
  ...
  errorHandler(_req: Request, res: Response, err: Error) {
