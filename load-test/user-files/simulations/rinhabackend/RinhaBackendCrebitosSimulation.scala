  ...
  setUp(
    validacaoTransacoesConcorrentes("d").inject(
      ...
      criterioClienteNaoEcontrado.inject(
        ...
        debitos.inject(
          rampUsersPerSec(1).to(440).during(12.seconds),
          constantUsersPerSec(440).during(12.seconds)
        ),
        creditos.inject(
          rampUsersPerSec(1).to(220).during(12.seconds),
          constantUsersPerSec(220).during(12.seconds)
        ),
        extratos.inject(
          rampUsersPerSec(1).to(20).during(12.seconds),
          constantUsersPerSec(20).during(12.seconds)
        )
      )
    )
